...
contract SupplyChain is   Ownable, FarmerRole, DistributorRole, RetailerRole, ConsumerRole
{
  ...
  // Define 'owner'
  // address owner; //Comment it as compile error shows already declared
...
//  }
  ...
  modifier verifyCaller (address _address) {
    require(msg.sender == _address," Not Correct Address"); 
    _;
  }
  ...
  modifier checkValue(uint _upc) {
   ...
   //items[_upc].distributorID.transfer(amountToReturn);
     ...
     //items[_upc].payable(consumerID).transfer(amountToReturn);
  ...
  require(items[_upc].itemState == State.Packed, "NotPacked state");
